...
MODEL_PATH="${DOSSIER_VLLM_MODEL_PATH:-${PROJECT_ROOT}/models/Qwen3.5-27B}"
SERVED_MODEL_NAME="${DOSSIER_VLLM_SERVED_MODEL_NAME:-${MODEL_PATH}}"
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0,1,2,3}"
TENSOR_PARALLEL_SIZE="${DOSSIER_VLLM_TP_SIZE:-4}"
MAX_MODEL_LEN="${DOSSIER_VLLM_MAX_MODEL_LEN:-50000}"
GPU_MEMORY_UTILIZATION="${DOSSIER_VLLM_GPU_MEMORY_UTILIZATION:-0.92}"
